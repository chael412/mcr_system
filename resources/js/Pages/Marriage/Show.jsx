...
const Show = ({ marriage }) => {
    ...
    const fileUrl = marriage.file ? `${API_URL}/${marriage.file}` : null;
        ...
        >
            ...
            <div className="flex flex-col items-center">
                <div className="px-4 py-1">
                    ...
                    {showContent && (
                        <>
                            <div className="flex justify-center items-center flex-col gap-2 font-semibold text-xl bg-gray-200 px-4 py-2 mb-1">
                                <h3>
                                    {`${marriage.husband_firstname} ${
                                        marriage.husband_middlename ?? ""
                                    } ${marriage.husband_lastname}`}{" "}
                                    and{" "}
                                    {`${marriage.husband_firstname} ${
                                        marriage.husband_middlename ?? ""
                                    } ${marriage.husband_lastname}`}
