...
const Index = () => {
    const {
        ...
        queryKey: "paginate_deaths",
        endpoint: "get_deaths",
    });

    const API_URL = useAppUrl();

    console.log(death_paginate);
    ...
    console.log("Member Paginate Data:", death_paginate);

    const deleteMember = async (birthId) => {
        const confirmDelete = window.confirm(
            "Are you sure you want to delete this death certificate record?"
        );

        if (confirmDelete) {
            try {
                const response = await axios.delete(
                    `${API_URL}/api/delete_death/${birthId}`
                );
        ...
        >
            ...
            <div className="mx-auto max-w-7xl px-4 mt-5">
                <div className="mb-5 font-semibold">
                    <h3>Death Certificate Section</h3>
                </div>
                <div className="flex justify-between items-center mb-4">
                    ...
                    <Link href="/death_certificates/create">
                ...
                <div className="h-[480px] overflow-y-auto">
                    <Table>
                        ...
                        <TableBody>
                            ...
                            {death_paginate?.data?.map((member, index) => (
